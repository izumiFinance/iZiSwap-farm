...
async function getIzumiswapFactory(receiverAddr, swapX2YModule, swapY2XModule, liquidityModule, limitOrderModule, flashModule, signer) {
    const iZiSwapJson = getContractJson(__dirname + '/../iZiSwap/iZiSwapFactory.json');
...
async function attachiZiSwapPool(poolAddr) {
    const iZiSwapPoolJson = getContractJson(__dirname + '/../iZiSwap/iZiSwapPool.json');
...
async function getPoolParts(signer) {
    const swapX2YModuleJson = getContractJson(__dirname + '/../iZiSwap/SwapX2YModule.json');
    ...
    const swapY2XModuleJson = getContractJson(__dirname + '/../iZiSwap/SwapY2XModule.json');
    ...
    const liquidityModuleJson = getContractJson(__dirname + '/../iZiSwap/LiquidityModule.json');
    ...
    const limitOrderModuleJson = getContractJson(__dirname + '/../iZiSwap/LimitOrderModule.json');
    ...
    const flashModuleJson = getContractJson(__dirname + '/../iZiSwap/FlashModule.json');
...
async function getNFTLiquidityManager(signer, factoryAddr, wethAddr) {
    const liquidityManagerJson = getContractJson(__dirname + '/../iZiSwap/LiquidityManager.json');
...
async function getSwap(signer, factoryAddr, wethAddr) {
    const swapJson = getContractJson(__dirname + '/../iZiSwap/Swap.json');
    const SwapFacrory = await ethers.getContractFactory(swapJson.abi, swapJson.bytecode, signer);
    var swap = await SwapFacrory.deploy(factoryAddr, wethAddr);
    await swap.deployed();
    return swap;
}
