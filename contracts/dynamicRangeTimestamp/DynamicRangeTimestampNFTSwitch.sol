...
contract DynamicRangeNFTSwitchTimestamp is BaseTimestamp {
    ...
    /// @param burnNFT true if withdraw token from nft
    function withdraw(uint256 tokenId, bool noReward, bool burnNFT) external nonReentrant {
        ...
        if (!burnNFT) {
            ...
            // burn nft
            // decrease and collect from iZiSwap
